...
const FreepikIntroduction = () => {
    ...
    const platformFeatures = [
        "Generowanie obrazów AI z 15+ modelami",
        "Edycja i retusz powered by AI",
        "Tworzenie wideo z pierwszej i ostatniej klatki",
        "Background removal i replacement",
        "Upscaling do 4K quality",
        "Freepik Spaces - workflow automation",
        "Multi-reference generation",
        "Batch processing i export"
    ];

    const journey = [
        { step: "1", title: "Poznaj platformę", desc: "Interfejs, nawigacja, podstawy" },
        { step: "2", title: "Zrozum modele AI", desc: "Jak działają, kiedy używać którego" },
        { step: "3", title: "Twórz pierwsze projekty", desc: "Praktyczne tutoriale krok po kroku" },
        { step: "4", title: "Opanuj Spaces", desc: "Automatyzacja i workflow" },
        { step: "5", title: "Skaluj produkcję", desc: "Profesjonalne techniki i best practices" }
    ];
                    ...
                    <div className="saas-card p-8 md:p-10">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h3 className="text-2xl font-bold text-white">
                                Freepik = Twoja AI Content Factory
                            </h3>
                        </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {whyFreepik.map((item, index) => {
                            ...
                            return (
                                <div
                                    key={index}
                                    className="group saas-card p-6 animate-fade-up"
                            ...
                            {journey.map((item, index) => (
                                <div key={index} className="relative">
                                    ...
                                    {index < journey.length - 1 && (
                                        <div className="hidden md:flex absolute top-12 -right-2 items-center justify-center z-20">
